  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Sağ: ok kapsayıcısı – Figma paddings */}
        <span
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            fill="none"
            stroke="var(--Neutrals-800, #FCBF44)"
            strokeWidth="2.2"
            strokeLinecap="round"
      ...
      {/* Menü – 103×47 kutular, alt alta ve aralıksız */}
      {open && (
        <div
          role="listbox"
              ...
              return (
                <button
                  ...
                  className={clsx(
                    ...
                    active && "ring-2 ring-[var(--Main-default,#D4EA33)]"
                  )}
                  style={{
                    display: "flex",
                    width: 103,
