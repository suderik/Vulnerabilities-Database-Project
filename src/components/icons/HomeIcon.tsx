...
export const HomeIcon = ({
    ...
    return (
        <svg
            className={className}
            width={size}
            height={(size * 23) / 24} // Orijinal oranı korumak için (24x23)
            viewBox="0 0 24 23"
            fill="none"
